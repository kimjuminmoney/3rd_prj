...
<!-- #breadcrumb:login/joinWelcome.gsp-->
<style>
body.full #container #content .complete .top_icon i svg rect, body.full #container #content .complete .top_icon i svg path {
	stroke: #00AB50;
}
</style>
<div id="container">
			...
			<div class="top_icon">
				<i>
					<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="none" viewBox="0 0 80 80">
						<rect width="78.5" height="78.5" x=".75" y=".75" stroke="#000000" stroke-width="1.5" rx="39.25"></rect>
						<path stroke="#000000" stroke-width="3" d="M23 39.333L34.333 50 57 26"></path>
					</svg>
				</i>
			</div>
