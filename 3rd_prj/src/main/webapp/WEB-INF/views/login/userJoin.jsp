...
<script>
    ...
    (function connectMemberIntegration() {
        ...
        // alert 메시지가 존재하면 표시하고 삭제하는 함수
        function showAlert() {
            var message = "${message}"; // redirectAttributes에서 전달한 메시지 가져오기
            if (message && message.trim() !== "") {
                alert(message);
            }
        }

        // 페이지 로드 시 showAlert 함수 호출
...
<div class="wrap">
	<div id="container">
	    	<div class="membership_input_wrap">
					<form name="frmJoin" id="userJoin_form" action="doUJoin.do" method="post" >
