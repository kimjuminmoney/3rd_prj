...
<section class="page login" id="_login">
    ...
    <div class="login_method_email">
        <form role="form" id="login_form" action="doLogin.do" method="post">
            <fieldset>
                ...
                <div class="ipt_group">
                    <label class="it stretch _label">
                        ...
                        <input type="text" id="id" name="id" class="_input" >
                    </label>
                    <label class="it stretch _label _password">
                        <span class="ph _login_password" style="display: none;">비밀번호</span>
                        <input type="password" id="pw" name="pw" class="_input" data-global-placeholder="._login_password" >
                    </label><br/>
