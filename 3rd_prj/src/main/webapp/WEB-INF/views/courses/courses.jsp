...
<div id="wrap">
    ...
    <c:choose>
    <c:when test="${ param.mcCode == csb.mcCode }">
    <c:out value="${ csb.mcName }"/>
    </c:when>
    </c:choose>
    </c:forEach>
    <c:if test="${ param.mcCode == 'all' }">
    <c:out value="전체"/>
    </c:if>
    </h2>
    </div>
    ...
    <span class="preview">
            <img src="http://localhost/daitdayoung/courses_data/${ cou.couCode}/${ cou.bannerImg }">
