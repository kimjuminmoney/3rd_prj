...
<head>
  <script src="https://www.edwith.org/static/js/vendor/html5shiv/dist/html5shiv.min.js?231109_47a067d4">
  </script>
  <script src="https://ssl.pstatic.net/static/connectfdn/edwith/RB.23.10.31.0/css/new_common.css">
  </script>

    <script>
        var g_ssc = "edwith.index";
        var ccsrv = "cc.naver.com";
        window.nsc = g_ssc;
    </script>
     <link href="/css_index.css" rel="stylesheet" />
    <script src="https://www.edwith.org/static/js/plugins/nclk_v0.4.5.js?231109_47a067d4">
    </script> 
...
<div class="slide_wrap NE=a:mkv">
    <ul class="list items" slide-list-container="" style="position: absolute; width: 4020px; left: -2412px;"><li>
    ...
    <li>
        ...
        <div class="pagination">
            ...
            <a href="#" class="dot" slide-btn-page="" data-page="1" data-nclk="kv.move"><span class="blind">1</span></a>
            
            <a href="#" class="dot on" slide-btn-page="" data-page="2" data-nclk="kv.move"><span class="blind">2</span></a>
            
            <a href="#" class="btn_pause" slide-btn-pause="" data-nclk="kv.pause"><span class="blind">배너 정지</span></a>
            <a href="#" class="btn_play" slide-btn-play="" style="display: none" data-nclk="kv.play"><span class="blind">배너 재생</span></a>
        </div>
