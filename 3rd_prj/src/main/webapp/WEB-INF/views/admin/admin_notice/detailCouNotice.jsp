        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">강좌공지 상세</h1>
                ...
                <div id="inqueryDetail" style="width:1000px; margin: 0 auto; margin-top: 100px">
	                <h6 id="inqueryTitle" class="h3 mb-4 text-gray-800" style="font-size: 20px"><c:out value="${ requestScope.cnTitle }"/></h6>
					<table>
					<tr>
						...
						<td style="padding-left: 10px"><c:out value="${ requestScope.cnDate }"/></td>
					</tr>				
					</table>
	                <hr>
