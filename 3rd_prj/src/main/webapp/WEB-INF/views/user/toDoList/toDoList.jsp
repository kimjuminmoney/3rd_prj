...
<div class="course_group course_join" data-course-group>
    <div class="course_lst class_area">
            ...
            <ul class="tab_content_list" data-course-card-ul>
                    ...
                    <li >
                        <div class="info_area " style="display: flex;margin-bottom: 0px;">
                        <!-- 강좌 베너 넣으면 좋을듯 -->
                            <!-- <div class="thumb">
                            ...
                            <div class="tit" style="flex: 1">
                                <a href="/onlineclass-tutorial/home">
                                    <strong class="title" style="padding-top: 15px;"><c:out value="${ todo.couName }"/></strong>
                                </a>
                                <!-- <div class="author">
                            ...
                            <c:if test="${ todo.examStatus eq 'Y' }">
                            <div style="flex: 1">
                            	<strong class="title" style="padding-top: 15px;">시 험 응 시</strong>    
                            </div>
                            </c:if>
                            <c:if test="${ todo.examStatus eq 'N' }">
                            <div style="flex: 1">
                            	<strong class="title" style="padding-top: 15px;">남은 시험 응시일 : <c:out value="${ todo.remainingperiod }"/>일</strong>    
                            </div>
                            </c:if>
                            
                            
                            <div style="flex: 1;">
                            	<strong class="title" style="padding-top: 15px;">남은 강의 기간 : <c:out value="${ todo.remainingperiod }"/>일</strong>    
							</div>
                            <div class="info_btns">
            ...
            <c:otherwise>
		        <!-- 수강신청 강좌가 없들 때 -->
					<div class="class_none">
						<div class="noti_wrap">
							<h4 class="noti_tit">나의 할 일이 없습니다.</h4>
						</div>
					</div>
			</c:otherwise>
            </c:choose>
