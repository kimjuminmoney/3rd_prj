                                ...
                                <div class="desc_wrap">
                                    <div class="info_lec">
                                        ...
                                        <div class="done_box">
                                            <div class="done_area">
                                                <div class="circle_progress_wrap lecture">
                                                    <div data-selector="c_progress" data-color="yellow">
                                                    <svg height="82" version="1.1" width="82" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="overflow: hidden; position: relative;">
                                                    <desc style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);">Created with Raphaël 2.1.2</desc>
                                                    <defs style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></defs>
                                                    <path fill="none" stroke="#ecf0f1" d="M41,7A34,34,0,1,1,40.89,7" stroke-width="4" stroke-linecap="round" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); stroke-linecap: round;"></path>
                                                    <path fill="none" stroke="none" d="M0,0" stroke-width="4" stroke-linecap="round" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); stroke-linecap: round;"></path>
                                                    </svg></div>
                                                    <div class="num">
                                                        <span class="val">0</span>
                                                        <span class="slash">/</span>
