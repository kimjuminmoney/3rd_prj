                ...
                <div class="menu_area">
                    <ul role="tablist">
                        <!-- [D] 선택된 탭 li에 aria-selected="true" 추가해주세요 -->
                            ...
                            <li role="tab" aria-selected="false" class="menu ico_cal" data-pc-only-menu="" style="display: none;">
                            ...
                            <li role="tab" aria-selected="false" class="menu ico_todo" data-pc-only-menu="" style="display: none;">
                            ...
                            <li role="tab" aria-selected="false" class="menu ico_noti_edwith" data-pc-only-menu="" style="display: none;">
