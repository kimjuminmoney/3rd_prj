                ...
                <div class="faq_write_box">
                    ...
                    <div class="write_tbl_box">
                        <table  id="customers">
                            ...
                            <tr>
                                <th>
                                    <span class="sjt">문의강좌</span>
                                </th>
                                <td colspan="3">
                                    <div class="slt"style="display: flex;">
                                    <label style="padding: 8px">강좌</label>
                                        <select class="_custom_slt" title="문의유형 선택" style="width:224px" data-voc-type>
                                            <option value="" >강좌선택하기</option>
                                            <option value="INQUIRY">코인 가즈아</option>
                                            <option value="ERROR">홍루이젠 가즈아</option>
                                        </select>
                                    <label style="padding: 8px">유형</label>
                                        <select class="_custom_slt" title="문의유형 선택" style="width:224px" data-voc-type>
                                            <option value="" >유형선택하기</option>
                                            <option value="INQUIRY">시험</option>
                                            <option value="ERROR">강의내용</option>
                                            <option value="PAYMENT">수료</option>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                        <input type="text"  placeholder="제목을 입력하세요" name="title" style="width: 750px; height: 40px" >
                                </td>
                            </tr>
                            <!-- <tr class="_optional" style="display:none">
                                ...
                                <td>
                                    <div class="slt">
                                        <select class="_custom_slt" title="운영체제 선택" style="width:224px" data-os>
                            ...
                            <tr class="_optional" style="display:none">
                                ...
                                <td>
                                    <div class="slt">
                                        <select class="_custom_slt" title="브라우저 선택" style="width:224px" data-browser>
                                            <option value="" selected>선택하기</option>
                            ...
                            <tr style="display:none" data-payment-voc>
                                ...
                                <td>
                                    <div class="slt">
                                        <select class="_custom_slt" title="문의유형 조건" style="width:224px" data-inquiry-type>
                            ...
                            <!-- <tr>
                                ...
                                <td>
                                    <label for="contact_email" class="it" style="width: 500px">
                                        <input type="text" value=""  name="contact_email" placeholder="이메일을 입력하세요">
                                    </label>
                                </td>
                            </tr> -->
                            <!-- <tr>
                                ...
                                <td>
                                    <label for="contact_phone_number" class="it" style="width: 500px">
                                        <input type="text" id="contact_phone_number" name="contact_phone_number" placeholder="전화번호를 입력하세요">
                                    </label>
                                </td>
                            </tr> -->
                            <tr>
                                ...
                                <td colspan="3">
                                        <textarea cols="30" rows="5" style="width: 750px;height:320px" placeholder="문의내용을 입력하세요"></textarea>
                                </td>
                            </tr>
                            <!-- <tr>
                                <th>
                    ...
                    <li class="" data-course="4271" data-course-uri="blockchain-and-society" data-course-name="블록체인과 암호화폐가 여는 미래">
                        <div class="info_area ">
                            <div class="thumb">
                                    ...
                                    <img src="https://cphinf.pstatic.net/mooc/20200319_294/1584596494784QueT7_JPEG/01_--_.jpg?type=ffn176_96" width="88" height="48" alt="강좌 썸네일">
                                </a>
                            </div>
                            <div class="tit">
