...
<section class="page mg_menu">
	...
	<div class="class_manager type2">
		...
		<ul>
					...
					<li>
						<div id="content">
        					<label style="font-size:30px;"><strong>필수설정</strong></label><input type="checkbox"/>
        					<label style="font-size:30px;"><strong>시험기간</strong></label>
        					<label style="font-size:30px;"><strong>통과기준</strong></label>
        					<label style="font-size:30px;"><strong>유의사항</strong></label>
