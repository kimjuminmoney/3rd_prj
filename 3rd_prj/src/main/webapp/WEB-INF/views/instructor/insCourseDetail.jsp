...
<link rel="icon" href="http://192.168.10.150/mvc_prj/common/main/favicon.png">
<!-- bootstrap CDN -->
...
<input type="hidden" id="__USER_ID" value="2674262">
<input type="hidden" id="__COURSE_ID" value="2024" />
<input type="hidden" id="__COURSE_OPEN_DAY" value="" />
<input type="hidden" id="__COURSE_CLOSE_DAY" value="" />
<input type="hidden" id="__COURSE_URI_PATH" value="python-data" />
...
<input type="hidden" id="__CONTROLLER_TYPE" value="chapter" />
...
<script>
    ...
    (function connectMemberIntegration() {
        ...
        var integrationUserId = Number(2674262);
    ...
    <input type="hidden" id="GA_USER_ID" value="0002674262" />
    <input type="hidden" id="GA_DIMENSION01" value="NEXT" /> 


    <input type="hidden" id="GA_DIMENSION02" value="NEXT" /> 
    <input type="hidden" id="GA_DIMENSION03" value="python-data" /> 
...
<div class="lnb">
    ...
    <div class="sns_layer " data-sns-layer>
        <div class="inner">
            <a href="#" class="ico_url" data-type="urlCopy" data-clipboard-text="www.edwith.org/python-data">URL복사</a>
    ...
    entry.initialize($('._sns_area'), htData);
            ...
            <div class="lecture_sub_tool">
                    ...
                    <div class="count_info">
                        <span class="count_like"><em>좋아요</em> 1145</span>
                        <span class="count_observe"><em>수강생</em> 13790</span>
                    </div>
    ...
    <!-- [D] 선택된 메뉴에 .active 추가, 구분선 추가시 <li class="hr"></li> 추가-->
            ...
            <li class="active">
                ...
                <!-- lecture.contType에 따라 url 분기처리 -->
                            ...
                            <ol class="lect_2dep">
                                <span class="title">모두를 위한 파이썬, 학습 가이드</span>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/25153?isDesc=false">학습을 위한 가이드</a></li>
                            ...
                            <ol class="lect_2dep">
                                <span class="title">CHAPTER 6: 문자열</span>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24384?isDesc=false">강의자료</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24381?isDesc=false">문자열</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24382?isDesc=false">문자열을 다루는 다양한 방법들</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24383?isDesc=false">&lt;실습&gt; 문자열 파싱</a></li>
                                    ...
                                    <li class=""><a href="/python-data/quiz/20967?isDesc=false">Chapter6: 퀴즈</a></li>
                            ...
                            <ol class="lect_2dep">
                                <span class="title">CHAPTER 7: 파일</span>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24388?isDesc=false">강의자료</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24385?isDesc=false">파일 열기</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24386?isDesc=false">파일 읽기</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24387?isDesc=false">&lt;실습&gt; 파일 열고 읽기</a></li>
                                    ...
                                    <li class=""><a href="/python-data/quiz/21576?isDesc=false">Chapter7: 퀴즈</a></li>
                            ...
                            <ol class="lect_2dep">
                                <span class="title">CHAPTER 8: 리스트</span>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24393?isDesc=false">강의자료</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24389?isDesc=false">리스트의 개념 및 특징</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24390?isDesc=false">리스트 활용하기</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24391?isDesc=false">리스트를 활용해 원하는 값 추출하기</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24392?isDesc=false">&lt;실습&gt; 문자열, 파일, 리스트 및 Guardian Pattern</a></li>
                                    ...
                                    <li class=""><a href="/python-data/quiz/21628?isDesc=false">Chapter8: 퀴즈</a></li>
                            ...
                            <ol class="lect_2dep">
                                <span class="title">CHAPTER 9: 딕셔너리</span>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24398?isDesc=false">강의자료</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24394?isDesc=false">딕셔너리 개념 및 특징</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24395?isDesc=false">딕셔너리를 활용한 데이터 빈도수 측정</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24396?isDesc=false">딕셔너리 활용하기</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24397?isDesc=false">&lt;실습&gt; 딕셔너리를 활용한 데이터 빈도수 측정</a></li>
                            ...
                            <ol class="lect_2dep">
                                <span class="title">CHAPTER 10: 튜플</span>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24402?isDesc=false">강의자료</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24399?isDesc=false">튜플 개념 및 특징</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24400?isDesc=false">튜플을 이용한 딕셔너리 정렬</a></li>
                                
                                    
                                    
                                    
                                    <li class=""><a href="/python-data/lecture/24401?isDesc=false">&lt;실습&gt; 튜플을 이용한 딕셔너리 정렬</a></li>
            ...
            <li class="">
                <a href="/python-data/forums/15974" title="무엇이든 자유토론" class="NPI=a:discuss">
                    <span class="menu">무엇이든 자유토론</span>
                </a>
            </li>
            ...
            <li class="ext ">
                <a href="http://www.py4e.com/" target="_blank">
                    ...
                    <span class="menu">PY4E 공식 사이트</span>
                </a>
            </li>
            ...
            <li class="ext ">
                <a href="http://do1.dr-chuck.com/pythonlearn/EN_us/pythonlearn.pdf" target="_blank">
                    ...
                    <span class="menu">교재 (파이썬3, 영문판)</span>
                </a>
            </li>
            ...
            <li class="ext ">
                <a href="http://www.py4inf.com/translations/KO/book_009_ko.pdf" target="_blank">
                    
                    <span class="menu">교재 (파이썬2, 한글판)</span>
                </a>
            </li>
            ...
            <li class="ext ">
                <a href="http://disqus.com/home/channel/pythonforeverybody/" target="_blank">
                    
                    <span class="menu">Discussion Forum</span>
                </a>
            </li>
            ...
            <li class="ext ">
                <a href="https://www.py4e.com/code3/" target="_blank">
                    
                    <span class="menu">코드 및 파일 다운로드</span>
                </a>
            </li>
        ...
        <ul class="ad" id="menuUl">
                    ...
                    <li><a href="/python-data/grade"><span>성적조회</span></a></li>
...
<script src="/static/js/src/entries/common/_lnbmenu.entry.browserfied.min.js?231109_47a067d4"></script>
<script>
    $(document).ready(function() {
...
<section class="page mg_menu">
	...
	<header class="page_header">
		<div class="group_lr mab10">
			<div class="group_r">
				...
				<form action="/python-data/search/lecture" method="get" class="it it_added input">
					<span class="ph">제목을 입력하세요.</span>
					<span class="input_area"><input type="text" name="searchText" data-global-placeholder=".ph"><input type="hidden" name="bbsId" value="13744"></span>
	...
	<div class="class_manager
		...
		<ul>
					...
					<li>
						<div class="chapter">
							<div class="le_txt"><strong>모두를 위한 파이썬, 학습 가이드</strong></div>
							
								<div class="time"><span class="blind">강의시간</span>04:39</div>
						...
						<ul class="sub">
									...
									<li >
										<a href="/python-data/lecture/25153">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>학습을 위한 가이드</strong>
											...
											<dl class="info">
												...
												<dd>2023.08.04</dd>
													...
													<dd><div class="time"><span class="blind">강의시간</span>04:39</div></dd>
					...
					<li>
						<div class="chapter">
							<div class="le_txt"><strong>CHAPTER 6: 문자열</strong></div>
						...
						<ul class="sub">
									...
									<li >
										<a href="/python-data/lecture/24384">
									...
									<li >
										<a href="/python-data/lecture/24381">
									...
									<li >
										<a href="/python-data/lecture/24382">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>문자열을 다루는 다양한 방법들</strong>
									...
									<li >
										<a href="/python-data/lecture/24383">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>&lt;실습&gt; 문자열 파싱</strong>
									...
									<li >
										<a href="/python-data/quiz/20967">
										
											<span class="ico_quiz"></span>
										
											<div class="le_txt">
												<strong>Chapter6: 퀴즈</strong>
					...
					<li>
						<div class="chapter">
							<div class="le_txt"><strong>CHAPTER 7: 파일</strong></div>
						...
						<ul class="sub">
									...
									<li >
										<a href="/python-data/lecture/24388">
									...
									<li >
										<a href="/python-data/lecture/24385">
									...
									<li >
										<a href="/python-data/lecture/24386">
									...
									<li >
										<a href="/python-data/lecture/24387">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>&lt;실습&gt; 파일 열고 읽기</strong>
									...
									<li >
										<a href="/python-data/quiz/21576">
										
											<span class="ico_quiz"></span>
										
											<div class="le_txt">
												<strong>Chapter7: 퀴즈</strong>
					...
					<li>
						<div class="chapter">
							<div class="le_txt"><strong>CHAPTER 8: 리스트</strong></div>
						...
						<ul class="sub">
									...
									<li >
										<a href="/python-data/lecture/24393">
									...
									<li >
										<a href="/python-data/lecture/24389">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>리스트의 개념 및 특징</strong>
									...
									<li >
										<a href="/python-data/lecture/24390">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>리스트 활용하기</strong>
									...
									<li >
										<a href="/python-data/lecture/24391">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>리스트를 활용해 원하는 값 추출하기</strong>
									...
									<li >
										<a href="/python-data/lecture/24392">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>&lt;실습&gt; 문자열, 파일, 리스트 및 Guardian Pattern</strong>
									...
									<li >
										<a href="/python-data/quiz/21628">
										
											<span class="ico_quiz"></span>
										
											<div class="le_txt">
												<strong>Chapter8: 퀴즈</strong>
					...
					<li>
						<div class="chapter">
							<div class="le_txt"><strong>CHAPTER 9: 딕셔너리</strong></div>
						...
						<ul class="sub">
									...
									<li >
										<a href="/python-data/lecture/24398">
									...
									<li >
										<a href="/python-data/lecture/24394">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>딕셔너리 개념 및 특징</strong>
									...
									<li >
										<a href="/python-data/lecture/24395">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>딕셔너리를 활용한 데이터 빈도수 측정</strong>
									...
									<li >
										<a href="/python-data/lecture/24396">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>딕셔너리 활용하기</strong>
									...
									<li >
										<a href="/python-data/lecture/24397">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>&lt;실습&gt; 딕셔너리를 활용한 데이터 빈도수 측정</strong>
					...
					<li>
						<div class="chapter">
							<div class="le_txt"><strong>CHAPTER 10: 튜플</strong></div>
						...
						<ul class="sub">
									...
									<li >
										<a href="/python-data/lecture/24402">
									...
									<li >
										<a href="/python-data/lecture/24399">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>튜플 개념 및 특징</strong>
									...
									<li >
										<a href="/python-data/lecture/24400">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>튜플을 이용한 딕셔너리 정렬</strong>
									...
									<li >
										<a href="/python-data/lecture/24401">
										
											<span class="ico_lecture"></span>
										
											<div class="le_txt">
												<strong>&lt;실습&gt; 튜플을 이용한 딕셔너리 정렬</strong>
...
<script src="/static/js/src/entries/chapter/list.entry.browserfied.min.js?231109_47a067d4"></script>
<script>
    $(document).ready(function() {
...
<script src="/static/js/src/entries/layouts/course.entry.browserfied.min.js?231109_47a067d4"></script>
<script>
$(document).ready(function(){
