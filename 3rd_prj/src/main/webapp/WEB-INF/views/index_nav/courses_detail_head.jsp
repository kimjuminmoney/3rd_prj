...
<meta http-equiv="origin-trial" content="">
		...
		<meta property="og:url" content="http://www.edwith.org/GPTSW">
	
		<meta property="og:type" content="article">
	
		<meta property="og:title" content="청소년을 위한 Chat GPT 강좌소개 : edwith">
	
		<meta property="og:description" content=" - 원광대학교SW중심대학사업단">
	
		<meta property="og:image" content="https://cphinf.pstatic.net/mooc/20231114_102/1699945915368nwsHz_JPEG/7VFAEoXblqlpvO6AigHH.jpg">
		...
		<meta name="keywords" content="&quot;청소년을 위한 Chat GPT, 원광대학교SW중심대학사업단, 인공지능 ,원광대학교 ,SW중심대학사업단 ,chatgpt">
	
		<meta name="description" content="청소년을 위한 Chat GPT ">
	

	
		<meta itemprop="name" content="청소년을 위한 Chat GPT 강좌소개 : edwith">
	
		<meta itemprop="description" content=" - 원광대학교SW중심대학사업단">
	
		<meta itemprop="image" content="https://cphinf.pstatic.net/mooc/20231114_102/1699945915368nwsHz_JPEG/7VFAEoXblqlpvO6AigHH.jpg">
...
<script type="text/javascript" async="" src="https://www.googletagmanager.com/gtag/js?id=G-0V6W0JCK4T&amp;cx=c&amp;_slc=1"></script>
    ...
    <script src="https://connect.facebook.net/en_US/all.js?hash=d6ba7d710f5f30ffad229357ddf2c3e2" async="" crossorigin="anonymous"></script>
...
<style type="text/css" id="wpc-core-style">@charset "UTF-8";
.wpc-full {
	width: 100%;
	height: 100%;
}
...
<body class="re_pack boost_course_main_body le_info win chrome chrome119" cz-shortcut-listen="true">


    <!-- Google Tag Manager (noscript) -->
    
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P2H76TF" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
...
<input type="hidden" id="__COURSE_ID" value="67376">
<input type="hidden" id="__COURSE_OPEN_DAY" value="">
<input type="hidden" id="__COURSE_CLOSE_DAY" value="">
<input type="hidden" id="__COURSE_URI_PATH" value="GPTSW">
<input type="hidden" id="__CURRENT_DATE" value="2023.12.05">
...
<input type="hidden" id="__CONTROLLER_TYPE" value="course">
...
<script>
    ...
    <input type="hidden" id="GA_DIMENSION03" value="GPTSW"> 
...
<style>
.boost_course_main_body.le_info #snb .btn.clr {
...
.boost_course_main_body.le_info #content .inc_sub .project,
...
<ul class="lnk">
        ...
        <li class="ose"><a href="courses_ose.do">산업안전교육</a></li>
...
<script src="https://www.edwith.org/static/js/src/entries/common/_gnbmenu.entry.browserfied.min.js?231130_26709717"></script>
<script>
