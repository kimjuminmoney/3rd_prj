...
<header id="header" class="course_search">
        <div class="layout_in" data-wrap-gnb-menu="">
    
    <h1 class="logo">
        <a class="N=a:gnb.edwith" href="/">
            <img height="" src="https://ssl.pstatic.net/static/m/mooc/p/partner/next/logo_v4.png?_=?231109_47a067d4" alt="edwith">
        </a>
    </h1>
    ...
    <script>
        function doLogin(){
            ...
            if(location.pathname == "/login"){
                ...
                if (returnUrl == "/" || returnUrl == "" || "naverSearch" == "error" || "naverSearch" == "neoid") {
                    returnUrl = "";
                } else {
    ...
    background-color:#00AB50;
        ...
        <!-- <div class="search_area">
            <div class="search_wrap">
                <a href="/courses/courses" class="btn_srch_all" style="background-color: #00AB50">공개강좌</a>
                <div class="it it_added input3 stretch">
                    <span class="ph _label_search_txt">원하는 강좌를 찾아보세요. (강좌명, 교수자명 등)</span>
                    <span class="input_area">
                        <input type="text" name="search_text" id="_input_search" data-global-placeholder="._label_search_txt" maxlength="200" autocomplete="off">
                        <button type="button" title="검색어 초기화" class="btn btn_type5 f_close_big" id="_btn_remove_text" style="display: none">검색어 초기화</button>
                    </span>

                    <span class="added">
                        <button type="submit" title="검색" class="btn" id="_btn_search"><span class="sr_only">검색</span></button>
                    </span>
                </div>
            </div>
        </div> -->
