...
public class PageController {
    ...
    public PageController (Integer pagesPerBlock, Integer postsPerPage, Long totalPostCount) {
...
// 인스턴스 생성
PageController pageContoller = new PageController(PAGES_PER_BLOCK, POST_PER_PAGE, totalPostCount);

try {
for(int i = 1; i <= pageContoller.getTotalLastPageNum(); i++) {
System.out.println(pageContoller.getElasticBlock(i));
}
} catch (Exception e) {
